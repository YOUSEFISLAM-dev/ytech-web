...
const translations = {
  en: {
    ...
    hero_subtitle: "The best digital solutions in artificial intelligence, web, mobile and desktop applications, as well as 3D interactive experiences, all with Egyptian expertise and using the latest tools and technologies.",
    hero_cta: "Explore Services",
    services_title: "Our Services",
    courses_title: "Courses (Soon)",
  ...
  ar: {
    ...
    nav_courses: "الدورات (قريبا)",
    nav_about: "من نحن",
    nav_contact: "تواصل",
    hero_title: "ابتكر مع واي-تيكس",
    hero_subtitle: "أحسن الحلول الرقمية في الذكاء الاصطناعي، وتطبيقات الويب والموبايل والكمبيوتر، وكمان بنقدملك تجارب تفاعلية ثلاثية الأبعاد، كل ده بخبرة مصرية وباستخدام أحدث الأدوات والتقنيات.",
    hero_cta: "استكشف الخدمات",
    services_title: "خدماتنا",
    courses_title: "الدورات (قريبا)",
    about_title: "من نحن",
    contact_title: "تواصل",
